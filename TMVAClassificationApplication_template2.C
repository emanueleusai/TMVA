...
{   
   ...
   TMVA::Reader *reader<mass> = new TMVA::Reader( "!Color:!Silent" );    

   // Create a set of variables and declare them to the reader
   // - the variable names MUST corresponds in name and type to those given in the weight file(s) used
   Float_t var<mass><number>;
   reader<mass>->AddVariable( "<var>", &var<mass><number>);//order needs to match the order in varsList.py

   // --- Book the MVA methods

   // Book method(s)
   reader<mass>->BookMVA("BDT<Mass> method", <weightFilePathMass> );
...
//       }
      ...
      BDT<mass> = reader<mass>->EvaluateMVA( "BDT<mass> method");
